...
class ViewController: UIViewController {
    ...
    @IBAction func beginButton(_ sender: Any) {// declare beginButton and connecto to view
 ...
 scheduledTimerWithTimeInterval()//call function scheduledwithtimeinterval
    ...
    func scheduledTimerWithTimeInterval(){
        ...
        timer = Timer.scheduledTimer(withTimeInterval: 0.083, repeats: true){ [weak self] _ in
...
//
//
//            while (currentWordIndex < bookText.count)do{
//
//            func wordChanger(){
//
//                print("in wordchanger func")
//                textBox.text = bookText[currentWordIndex]
//                print(currentWordIndex)
//                print(bookText[currentWordIndex])
//
//
//                wordChanger()
//
